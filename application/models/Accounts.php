...
class Accounts extends CI_Model {
    ...
    //    echo $this->db->last_query();
     ...
     public function delete_payrolldata($id)
    {
    	$this->db->where('id', $id);	
    ...
    public function biweekly_delete_payrolldata($id)
    {
    	$this->db->where('id', $id);	
    ...
    public function weekly_delete_payrolldata($id)
    {
    	$this->db->where('id', $id);	
    ...
    public function monthly_delete_payrolldata($id)
    {
    	$this->db->where('id', $id);	
