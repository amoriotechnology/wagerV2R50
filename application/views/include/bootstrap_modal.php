...
<?php if(in_array(BOOTSTRAP_MODALS['add_states'],$bootstrap_modal)){ ?>
...
<?php } if(in_array(BOOTSTRAP_MODALS['dailybreak_add'],$bootstrap_modal)){ ?>
<!------ Add New Dailybreak-->  
               ...
               <form id="insert_daily_break" method="post">
                   <div class="panel-body">
                       ...
                       <div class="form-group row">
                           ...
                           <div class="col-sm-6">
                              <input type="text"class="decimal form-control" required name ="dbreak" id="dbreak" placeholder="Integer and decimal only"/>
                           </div>
                       </div>
                   </div>
           </div>
